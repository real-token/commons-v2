  ...
  walletConnect: {
    ...
    sessionProposal: {
      ...
      permissions: {
        ...
        wallet_getPermissions: "View permissions",
        wallet_requestPermissions: "Request permissions",
        wallet_registerOnboarding: "Register onboarding",
        wallet_watchAsset: "Watch assets",
        wallet_scanQRCode: "Scan QR code",
        wallet_getCallsStatus: "Get calls status",
        wallet_showCallsStatus: "Show calls status",
        wallet_sendCalls: "Send batch calls",
