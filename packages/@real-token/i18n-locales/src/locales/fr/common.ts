const common = {
  ...
  wallet: {
    ...
    readOnly: {
      title: "Lecture seul",
      description:
        "Vous pouvez vous connecter à une adresse en mode lecture seule uniquement.",
      inputPlaceholder: "Adresse ou ENS domain à visualier",
      wrongAddressFormat:
        "Le format d'adresse ou de l'ENS domain n'est pas valide",
  ...
  general: {
    ...
    noConnectedWallet:
      "S'il-vous-plaît connecter un portefeuille pour continuer (Aide : en bas à droite)",
    nextButton: "Suivant",
    noAdminError: "Vous n'êtes pas un admininistrateur",
  },
  actionButton: {
    watchOnly:
      "Vous êtes connectés en lecture seule. Cela signifie que vous ne pouvez pas interagir avec ce compte.",
  },
} as const;
