  ...
  walletConnect: {
    ...
    sessionProposal: {
      ...
      permissions: {
        ...
        eth_accounts: "Ver cuentas",
        eth_requestAccounts: "Solicitar cuentas",
        eth_sendRawTransaction: "Enviar transacciones brutas",
        eth_sign: "Firmar transacciones",
        eth_signTransaction: "Firmar transacciones",
        eth_signTypedData: "Firmar datos tipados",
        eth_signTypedData_v3: "Firmar datos tipados v3",
        eth_signTypedData_v4: "Firmar datos tipados v4",
        eth_sendTransaction: "Enviar transacciones",
        personal_sign: "Firmar mensajes",
        wallet_switchEthereumChain: "Cambiar de red",
        wallet_addEthereumChain: "Agregar red",
        wallet_getPermissions: "Ver permisos",
        wallet_requestPermissions: "Solicitar permisos",
        wallet_registerOnboarding: "Registrar onboarding",
        wallet_watchAsset: "Vigilar activos",
        wallet_scanQRCode: "Escanear código QR",
        wallet_getCallsStatus: "Obtener estado de llamadas",
        wallet_showCallsStatus: "Mostrar estado de llamadas",
        wallet_sendCalls: "Enviar llamadas agrupadas",
        wallet_getCapabilities: "Obtener capacidades",
        wallet_grantPermissions: "Otorgar permisos",
        wallet_revokePermissions: "Revocar permisos",
        wallet_getAssets: "Obtener activos",
    ...
    authRequest: {
      wantToAuthenticate: '"{{name}}" quiere autenticarse',
      chains: "Cadenas solicitadas: {{count}}",
      buttons: {
        approve: "Aprobar",
        reject: "Rechazar",
      },
      notifications: {
        ...
        accepted: "Autenticación aceptada",
        refused: "Autenticación rechazada",
      },
    },
  },
} as const;
